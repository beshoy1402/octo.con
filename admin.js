      ...
      <div class="settings-card" style="margin-bottom:24px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:16px">
          ...
          <div class="form-group">
            ...
            <div style="display:flex;gap:8px;align-items:center">
              <input type="color" id="catColor" value="#7C3AED" style="width:44px;height:38px;border:none;cursor:pointer;border-radius:8px;background:transparent">
              <input class="form-control" id="catColorHex" placeholder="#7C3AED" style="flex:1" oninput="syncCatColor()">
            </div>
          </div>
          <div class="form-group">
  ...
  return `<tr id="catrow-${c.id}">
    ...
    <td>
      <div style="display:flex;align-items:center;gap:8px">
        <div style="width:20px;height:20px;border-radius:50%;background:${c.color || '#7C3AED'}"></div>
        <span style="font-size:12px;color:var(--text3)">${c.color || '#7C3AED'}</span>
      </div>
    </td>
...
function editCategory(id) {
  ...
  document.getElementById('catColor').value = c.color || '#7C3AED';
  document.getElementById('catColorHex').value = c.color || '#7C3AED';
...
function resetCategoryForm() {
  ...
  document.getElementById('catColor').value = '#7C3AED';
  document.getElementById('catColorHex').value = '#7C3AED';
...
async function saveCategoryForm() {
  ...
  const cat = {
    ...
    color:       document.getElementById('catColorHex').value.trim() || '#7C3AED',
